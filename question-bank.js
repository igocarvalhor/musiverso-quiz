...
const perguntas = [
  ...
  { nivel: "dificil", topico: "harmonia-funcional", pergunta: "Quantos tons tem a escala maior?", opcoes: ["5", "6", "7", "8"], resposta: 2, explicacoes: ["Incorreto. 5 tons nao corresponde a estrutura da escala maior.", "Incorreto. 6 tons nao representa corretamente a soma dos intervalos.", "Correto. A escala maior possui 7 tons (equivalente a 12 semitons organizados em T-T-ST-T-T-T-ST).", "Incorreto. 8 representa numero de notas, nao de tons."] },
  { nivel: "dificil", topico: "harmonia-funcional", pergunta: "Quantos tons tem a escala menor natural?", opcoes: ["3", "4", "5", "6"], resposta: 1, explicacoes: ["Incorreto. 3 tons nao representa a estrutura completa.", "Correto. A escala menor natural possui 4 tons distribuidos na sua estrutura.", "Incorreto. 5 tons nao corresponde a formula correta desta alternativa.", "Incorreto. 6 tons excede a estrutura real."] },
  ...
  { nivel: "dificil", topico: "harmonia-funcional", pergunta: "Qual e a formula da escala menor natural?", opcoes: ["T ST T T ST T T", "T T ST T T T ST", "ST T T ST T T T", "T T T ST T ST T"], resposta: 0, explicacoes: ["Correto. T-ST-T-T-ST-T-T define a estrutura da escala menor natural.", "Incorreto. Essa e a formula da escala maior.", "Incorreto. A ordem dos intervalos esta incorreta.", "Incorreto. Nao corresponde a nenhuma escala padrao."] },
  { nivel: "dificil", topico: "harmonia-funcional", pergunta: "Uma triade tem quantas notas?", opcoes: ["2", "3", "4", "5"], resposta: 1, explicacoes: ["Incorreto. 2 notas formam um intervalo.", "Correto. Uma triade e formada por tres notas: fundamental, terca e quinta.", "Incorreto. 4 notas formam tetrade.", "Incorreto. 5 notas nao define triade."] },
  { nivel: "dificil", topico: "harmonia-funcional", pergunta: "Triade maior possui:", opcoes: ["Terca maior", "Terca menor", "Quarta", "Segunda"], resposta: 0, explicacoes: ["Correto. A triade maior possui terca maior (4 semitons acima da fundamental).", "Incorreto. Terca menor caracteriza triade menor.", "Incorreto. Quarta nao define triade.", "Incorreto. Segunda nao faz parte da estrutura basica."] },
  { nivel: "dificil", topico: "harmonia-funcional", pergunta: "Triade menor possui:", opcoes: ["Terca maior", "Terca menor", "Quarta", "Segunda"], resposta: 1, explicacoes: ["Incorreto. Terca maior define acorde maior.", "Correto. A triade menor possui terca menor (3 semitons acima da fundamental).", "Incorreto. Quarta nao define triade.", "Incorreto. Segunda nao define acorde."] },
  { nivel: "dificil", topico: "harmonia-funcional", pergunta: "O V grau tem funcao:", opcoes: ["Tonica", "Dominante", "Subdominante", "Relativa"], resposta: 1, explicacoes: ["Incorreto. Nao representa repouso.", "Correto. O V grau exerce funcao dominante, criando tensao.", "Incorreto. Subdominante e IV e II.", "Incorreto. Relativa nao e funcao principal."] },
  { nivel: "dificil", topico: "harmonia-funcional", pergunta: "O I grau tem funcao:", opcoes: ["Dominante", "Tonica", "Subdominante", "Sensivel"], resposta: 1, explicacoes: ["Incorreto. Nao gera tensao.", "Correto. O I grau e a tonica, centro de repouso.", "Incorreto. Nao prepara tensao.", "Incorreto. Sensivel e VII."] },
  { nivel: "dificil", topico: "harmonia-funcional", pergunta: "Cadencia V-I e:", opcoes: ["Imperfeita", "Perfeita", "Plagal", "Deceptiva"], resposta: 1, explicacoes: ["Incorreto. Nao e imperfeita.", "Correto. V-I e cadencia perfeita (autentica).", "Incorreto. Plagal e IV-I.", "Incorreto. Deceptiva e V-VI."] },
  { nivel: "dificil", topico: "harmonia-funcional", pergunta: "Quantos semitons tem uma quinta justa?", opcoes: ["5", "6", "7", "8"], resposta: 2, explicacoes: ["Incorreto. 5 e quarta justa.", "Incorreto. 6 e tritono.", "Correto. Quinta justa possui 7 semitons.", "Incorreto. 8 e sexta menor."] },
  { nivel: "dificil", topico: "harmonia-funcional", pergunta: "Quantos semitons tem uma terca maior?", opcoes: ["2", "3", "4", "5"], resposta: 2, explicacoes: ["Incorreto. 2 e segunda maior.", "Incorreto. 3 e terca menor.", "Correto. Terca maior possui 4 semitons.", "Incorreto. 5 e quarta justa."] },
  { nivel: "dificil", topico: "harmonia-funcional", pergunta: "O que e enarmonia?", opcoes: ["Mesmo som, nomes diferentes", "Notas diferentes", "Intervalos iguais", "Acordes iguais"], resposta: 0, explicacoes: ["Correto. Enarmonia e quando duas notas tem o mesmo som com nomes diferentes (ex: C# e Db).", "Incorreto. Notas diferentes nao caracterizam enarmonia.", "Incorreto. Intervalos iguais nao definem o conceito.", "Incorreto. Acordes iguais nao definem enarmonia."] },
  { nivel: "dificil", topico: "harmonia-funcional", pergunta: "O que e modulacao?", opcoes: ["Mudanca de ritmo", "Mudanca de tonalidade", "Mudanca de intensidade", "Mudanca de timbre"], resposta: 1, explicacoes: ["Incorreto. Ritmo nao muda tonalidade.", "Correto. Modulacao e a mudanca de tonalidade dentro de uma musica.", "Incorreto. Intensidade nao altera tonalidade.", "Incorreto. Timbre nao define modulacao."] },

  // HARMONIA FUNCIONAL — FACIL
  { nivel: "facil", topico: "harmonia-funcional", pergunta: "O que e funcao harmonica?", opcoes: ["Funcao que define a intensidade da musica", "Funcao que define o papel do acorde na tonalidade", "Funcao que define a velocidade", "Funcao que define o timbre"], resposta: 1, explicacoes: ["Incorreto. Nao define intensidade.", "Correto. Define o papel do acorde na tonalidade.", "Incorreto. Nao define velocidade.", "Incorreto. Nao define timbre."] },
  ...
  { nivel: "facil", topico: "harmonia-funcional", pergunta: "Na progressao C - F - G - C, qual acorde exerce funcao dominante?", opcoes: ["F", "Am", "G", "C"], resposta: 2, explicacoes: ["Incorreto. F e subdominante.", "Incorreto. Am nao aparece nesta progressao.", "Correto. G e o V grau e exerce funcao dominante.", "Incorreto. C e tonica."] },
  ...
  { nivel: "medio", topico: "harmonia-funcional", pergunta: "Na progressao Dm - G - C, a sequencia funcional correta e:", opcoes: ["Tonica - Dominante - Tonica", "Subdominante - Dominante - Tonica", "Dominante - Tonica - Subdominante", "Tonica - Subdominante - Dominante"], resposta: 1, explicacoes: ["Incorreto. Dm nao e tonica.", "Correto. Dm (SD), G (D), C (T).", "Incorreto. Ordem incorreta.", "Incorreto. Nao resolve corretamente."] },
  { nivel: "medio", topico: "harmonia-funcional", pergunta: "Na progressao C - Am - Dm - G, o acorde Am exerce:", opcoes: ["Dominante", "Subdominante", "Tonica relativa", "Sensivel"], resposta: 2, explicacoes: ["Incorreto. Nao cria tensao.", "Incorreto. Nao prepara dominante diretamente.", "Correto. Am e VI grau, tonica relativa.", "Incorreto. Nao e sensivel."] },
  { nivel: "medio", topico: "harmonia-funcional", pergunta: "Qual cadencia esta presente em G - C?", opcoes: ["Plagal", "Perfeita", "Interrompida", "Modal"], resposta: 1, explicacoes: ["Incorreto. Plagal e IV-I.", "Correto. V-I e cadencia perfeita.", "Incorreto. Nao e interrompida.", "Incorreto. Modal nao se aplica aqui."] },
  ...
  { nivel: "medio", topico: "harmonia-funcional", pergunta: "Qual acorde cria expectativa de resolucao?", opcoes: ["I grau", "III grau", "IV grau", "V grau"], resposta: 3, explicacoes: ["Incorreto. Tonica resolve.", "Incorreto. III nao e principal.", "Incorreto. IV prepara.", "Correto. V grau gera expectativa de resolucao."] },
